...
TARWGCEOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "TARWGCEOptions",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = TARWGCEResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
TARWGCE <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("TARWGCE requires jmvcore to be installed (restart may be required)")
